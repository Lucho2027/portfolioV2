<template>
  <div class="z-[10]">
    ...
    <UContainer class="border rounded-lg p-2 text-xs bg-green-600 bg-opacity-25">
      ...
      along the way. When I'm not coding, you'll find me hanging out online, cheering for my favorite soccer team, or
      soaking in live music vibes. Life's a blend of bytes and beats, and I'm here to craft seamless digital solutions
      while enjoying the rhythm of life beyond the screen. Join me on this exciting journey where technology meets
      passion!
    </UContainer>
  </div>
</template>
